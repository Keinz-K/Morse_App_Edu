...
{
    public class MorseEventhandler
    {/*
        Form1 form1 = new Form1();
        private void Form1Load()
        {
            form1.Codeinput.Width = 350;
            Size defaultpanelsize = new Size(440, 270);
            //stopwatch.Start();
            form1.localtime.Stop();
            //localtime.Start();
            GenePanel.Hide();
            Codeinput.Height = 45;
            ...
            Understand.Location = new Point(186, 150);
            Dontunderstand.Location = new Point(310, 150);
